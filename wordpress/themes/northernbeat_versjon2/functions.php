...
if ( function_exists( 'add_image_size' ) ) { 
	add_image_size( 'referanseimage', 448, 9999, true );
	add_image_size( 'referansetoppbilde', 1140, 9999 );
	add_image_size( 'referansesliderthumb', 283, 250, true );
	add_image_size( 'referanseansatt', 400, 400, true );
}
...
function northernbeat_widgets_init() {
	...
	register_sidebar( array(
		...
		'name' => __( 'Recent Projects Widget Area', 'northernbeat' ),

		'id' => 'sidebar-recent',

		'description' => __( 'Appears on frontpage.', 'northernbeat' ),

		'before_widget' => '<aside id="%1$s" class="widget %2$s">',

		'after_widget' => '</aside>',

		'before_title' => '<h3 class="miniTitle">',
...
//adds support for and registrerts custom post types
//Custom post type: Referanser
function nb_referanse_init() {
  $labels = array(
    'name'               => 'Referanser',
    ...
    'new_item'           => 'Ny referanser',
    'all_items'          => 'Alle referanser',
    'view_item'          => 'Vis referanse',
    'search_items'       => 'Søk i referanser',
    'not_found'          => 'Ingen funnet',
    'not_found_in_trash' => 'Ingen funnet i søppelkurven',
    'parent_item_colon'  => '',
  ...
  register_post_type( 'referanse', $args );
}
add_action( 'init', 'nb_referanse_init' );

	// Register Custom Taxonomy  
register_taxonomy('nb_referanse_taxonomy',array('referanse'), array(  
    'hierarchical' => true, // define whether to use a system like tags or categories  
    //'labels' => $labels,  
    'show_ui' => true,  
    'query_var' => true,  
    'rewrite' => array( 'slug' => 'referansetype' )
));  

//Custom post type: Ansatte
function nb_ansatt_init() {
  $labels = array(
    'name'               => 'Ansatte',
    'singular_name'      => 'Ansatt',
    'add_new'            => 'Legg til',
    'add_new_item'       => 'Legg til ansatt',
    'edit_item'          => 'Rediger ansatt',
    'new_item'           => 'Ny ansatt',
    'all_items'          => 'Alle ansatte',
    'view_item'          => 'Vis ansatt',
    'search_items'       => 'Søk i ansatte',
    'not_found'          => 'Ingen funnet',
    'not_found_in_trash' => 'Ingen funnet i søppelkurven',
    'parent_item_colon'  => '',
    'menu_name'          => 'Ansatte'
...
add_action( 'init', 'nb_ansatt_init' );

//Custom post type: Tjenester
function nb_tjenester_init() {
  $labels = array(
    'name'               => 'Tjenester',
    ...
    'new_item'           => 'Ny tjeneste',
    'all_items'          => 'Alle tjenester',
    'view_item'          => 'Vis tjeneste',
    'search_items'       => 'Søk i tjenester',
    'not_found'          => 'Ingen funnet',
    'not_found_in_trash' => 'Ingen funnet i søppelkurven',
    'parent_item_colon'  => '',
    'menu_name'          => 'Tjenester'
  ...
  register_post_type( 'tjeneste', $args );
}
add_action( 'init', 'nb_tjenester_init' );

//Custom post type: Aktuelt
function nb_aktuelt_init() {
  $labels = array(
    'name'               => 'Nyheter',
    'singular_name'      => 'Nyhet',
    'add_new'            => 'Legg til',
    'add_new_item'       => 'Legg til nyhet',
  ...
  register_post_type( 'aktuelt', $args );
}
add_action( 'init', 'nb_aktuelt_init' );
